---
name: feyagate
description: Control multi-platform smart home devices via MCP protocol. Supports Xiaomi/Mi Home, Tuya, Midea, eWeLink, Serial, and GPIO platforms. Provides cross-platform device discovery and control, MIOT device properties, XiaoAI speaker TTS/music, scheduled tasks, trigger automation, vision AI analysis, memory system, room management, and skill management. Use when working with smart home, IoT device control, Xiaomi, Tuya, Midea, eWeLink, MIOT protocol, cameras, snapshots, surveillance, XiaoAI speakers, TTS, automation, scheduling, or home automation.
---

# FeyaGate Skill

MCP-based multi-platform smart home gateway supporting Xiaomi, Tuya, Midea, eWeLink, Serial, and GPIO.
